...
use ic_embedders::{
    ...
    CompilationResult, InitialStateData, SerializedModule, SerializedModuleBytes, WasmtimeEmbedder,
};
...
impl SandboxManager {
    ...
    pub fn create_execution_state_via_file(
        ...
        let initial_state_data: InitialStateData = {
            ...
            let initial_state_file = unsafe { File::from_raw_fd(initial_state_data) };
